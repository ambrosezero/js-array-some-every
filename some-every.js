...
function hasAZero(num) {
    ...
    // let numArray = Array.from(String(num), myFunc);
    // ????? WHY DOES THE ABOVE ALSO WORK TO MAKE THE NUMBER AN ARRAY????

    return String(num).split('').some((n) => { return n == 0 })
}
...
function hasNoDuplicates(arr) {
    // ????? SEEMS LIKE THERE MUST BE A BETTER WAY OF DOING THIS
